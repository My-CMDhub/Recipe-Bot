...
-- grocery predictions, feedback, learning system, and recipes
-- =====================================================

-- =====================================================
-- TABLE 1: recipes
-- =====================================================
-- Purpose: Store recipe names for daily suggestions
-- =====================================================
CREATE TABLE IF NOT EXISTS recipes (
    id BIGSERIAL PRIMARY KEY,
    
    -- Recipe name (e.g., "Pasta Carbonara", "Chicken Curry")
...
-- =====================================================
-- TABLE 2: recipe_history
-- =====================================================
-- Purpose: Track which recipes were sent on which dates
-- Think of it as: A log of daily recipe suggestions
-- Relationship: Many history records belong to one recipe (one-to-many)
-- =====================================================
CREATE TABLE IF NOT EXISTS recipe_history (
    id BIGSERIAL PRIMARY KEY,
    
    -- Which recipe was sent?
    recipe_id BIGINT NOT NULL REFERENCES recipes(id) ON DELETE CASCADE,
    
    -- On which date was it sent? (format: YYYY-MM-DD)
...
CREATE INDEX IF NOT EXISTS idx_recipe_history_sent_date ON recipe_history(sent_date);
